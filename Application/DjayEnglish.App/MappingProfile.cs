...
namespace DjayEnglish.App
{
    ...
    public class MappingProfile : Profile
    {
        ...
        public MappingProfile()
        {
            ...
            this.CreateMap<Server.ObjectModels.QuizCandidate, QuizCandidate>().ReverseMap();
            this.CreateMap<Server.ObjectModels.QuizExample, QuizExampleCandidate>().ReverseMap();
            this.CreateMap<Server.ObjectModels.QuizAnswerOptionCandidate, QuizAnswerOptionCandidate>().ReverseMap();
